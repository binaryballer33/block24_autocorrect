...
const getClosestWord = (word, words, distanceFn, threshold) => {
  ...
  return closestDistance <= threshold ? closestWord : word;
}
...
console.log(["I don't have any pets"], getRelevantSentences((s) => s.length > 17, sentences));
